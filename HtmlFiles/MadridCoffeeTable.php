...
<div class="AllContainer" style="display: flex; margin-top: 2%; gap: 20%;">
    ...
    <div class="Container1" style="width: 30%; margin-left: 5%; font-size: 24px">
        <strong><p>Clean lines and organic shapes come together in a floating design to make the Madrid coffee table a sensory, vibrant piece for your interior. Designed by Morten Georgsen, this classic yet contemporary coffee table makes modern statement in any space.</p></strong>

    </div>

    <div class="Container2">
        <button style="font-size: 20px; width: 150%; padding: 15px;background-color: black; color: white;" onclick="window.location.href='MadridProductDetails.php'">Product Details</button>
        <button style="font-size: 20px; width: 150%; padding: 15px; margin-top: 10%;background-color: black; color: white;" onclick="window.location.href='MadridMeasurementDetails.php'">Measurements</button>
...
<div clas="ArtImage" style="margin-top: 3%;">
        ...
        <img src="../Images/MadridImage6.jpg" alt="ArtImage" title="ArtImage" style="width: 97%; height: 10%; margin-left: 2%;margin-right: 2%; border: 2px solid transparent; border-radius: 10px; box-shadow:0px 0px 10px gray;">
</div>
...
<div class="Details" style="display: flex; gap:20%">
    <div class="Box1" style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-left: 2%;">
        <h2 style="font-weight: bold; ">Combine different sizes</h2>
        <p>The floating design of the Madrid coffee table can easily stand alone, but it can also be combined with other tables, such as the Madrid side table, for a more cohesive look.</p>
    </div>
    ...
    <div class="Box2"  style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-right: 1%;"> 
        <h2 style="font-weight: bold; ">Visual softness</h2>
        <p>The streamlined design of Madrid makes it stand out. At the same time, the table's round shape creates a visual softness that opens up any space.</p>
