...
<div class="AllContainer" style="display: flex; margin-top: 2%; gap: 20%;">
    ...
    <div class="Container1" style="width: 30%; margin-left: 5%; font-size: 24px">
        <strong><p>Evoking the beauty of Moiz simplicity, this limited edition Sweet Art ottoman adds a touch of indulgence to your favorite corners. Its puffed-up shape and rich texture offer a versatile design that enhances any space, bringing a hint of luxury to your everyday.</p></strong>

    </div>

    <div class="Container2">
        <button style="font-size: 20px; width: 150%; padding: 15px;background-color: black; color: white;" onclick="window.location.href='OttomanProductDetails.php'">Product Details</button>
        <button style="font-size: 20px; width: 150%; padding: 15px; margin-top: 10%;background-color: black; color: white;" onclick="window.location.href='ArtOttomanMeasurementsDetails.php'">Measurements</button>
...
<div clas="ArtImage" style="margin-top: 3%;">
        ...
        <img src="../Images/ArtOttoman6.jpg" alt="ArtOttoman6" title="ArtOttoman6" style="width: 97%; height: 10%; margin-left: 2%;margin-right: 2%; border: 2px solid transparent; border-radius: 10px; box-shadow:0px 0px 10px gray;">
</div>
...
<div class="Details" style="display: flex; gap:20%">
    <div class="Box1" style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-left: 2%;">
        <h2 style="font-weight: bold; ">Sweet Art kollektion</h2>
        <p>Designed by Charlotte Høncke, our first female designer, this limited edition kollektion creates an indulgently relaxing space, combining timeless Moiz heritage with modern design.</p>
    </div>
    ...
    <div class="Box2"  style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-right: 1%;"> 
        <h2 style="font-weight: bold; ">Cohesive style</h2>
        <p>The ottoman’s sponge-like softness mirrors the pastry-inspired armchair and scalloped ottoman from the kollektion. While each piece is designed to stand out on its own, they also pair beautifully.</p>
...
<div class="HelenaPicks">
    ...
    <div class="DiningChair">
        <a href="DiningChair"><img src="../Images/DiningChair.jpg" alt="DiningChair" title="DiningChair"></a>  
