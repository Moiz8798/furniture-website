...
<html>
    <head>
        ...
        <title>MadridProductDetails</title>
    ...
    <body>
        <h1 style="margin-left: 5%; color: white;">Madrid Coffee Table Product Details</h1>
        <div class="ArtDetails"> 
            ...
            <?php
                ...
                include('../PhpFiles/MadridProduct.php'); 
                
                getMadridProductDetails($conn)
                ?>
            </div>
        </div>
    </body>
