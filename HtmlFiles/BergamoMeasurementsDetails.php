...
<html>
    <head>
        ...
        <title>BergamoSofaMeasurementsDetails</title>
...
@media screen and (max-width: 480px) {
    ...
    <body>
        <h1 style="margin-left: 5%; color: white;">Bergamo Sofa Measurements Details</h1>
        <h2 style="color: white;text-align: center;">Dimensions and weights</h2>
        <div class="ArtDetails"> 
            <div class="Info">
            <?php
    include('../PhpFiles/db_connection.php'); 
    include('../PhpFiles/BergamoMeasurements.php'); 

displayBergamoMeasurements($conn);
?>
