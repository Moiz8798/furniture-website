    ...
    <head>
        ...
        <style>
            ...
            @media screen and (max-width: 1200px) {
                ...
                .SweetChair, .SweetOttoman, .Bergamo, .Bellagio, .CoffeeTable, .DiningChair, .CornerSofa {
                    width: 100%;
                    text-align: center;
                }
        
                .SweetChair img, .SweetOttoman img, .Bergamo img, .Bellagio img, .CoffeeTable img, .DiningChair img, .CornerSofa img {
                    width: 100%;
                    height: auto;
                }
...
$productName = 'Bolzano chair with swivel base';
...
<div class="AllContainer" style="display: flex; margin-top: 2%; gap: 20%;">
    ...
    <div class="Container1" style="width: 30%; margin-left: 5%; font-size: 24px">
        <strong><p>Designed by Morten Georgsen, the Bolzano armchair is made to stand out. A timeless expression with a cocooning feel, this modern accent chair combines soft organic shapes with minimalistic lines. Elegant with a high level of comfort, it’s simplicity allows it to stand alongside the Bolzano sofa as a matching set or alone as a statement piece.</p></strong>

    </div>

    <div class="Container2">
        <button style="font-size: 20px; width: 150%; padding: 15px;background-color: black; color: white;" onclick="window.location.href='BolzoneChairProductDetails.php'">Product Details</button>
        <button style="font-size: 20px; width: 150%; padding: 15px; margin-top: 10%;background-color: black; color: white;" onclick="window.location.href='BolzoneChairMeasurementsDetails.php'">Measurements</button>
...
<div clas="ArtImage" style="margin-top: 3%;">
    ...
    <iframe src="../Images/BalzoneChairVideo.mp4" 
...
<div class="Details" style="display: flex; gap:20%">
    <div class="Box1" style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-left: 2%;">
        <h2 style="font-weight: bold; ">360° CURVE</h2>
        <p>Complemented by a rounded armrest that continues throughout the back, the Bolzano armchair is crafted with a curved front panel that offers a 360°</p>
    </div>
    ...
    <div class="Box2"  style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-right: 1%;"> 
        <h2 style="font-weight: bold; ">ELEGANT SILHOUETTE</h2>
        <p>With a refined, round silhouette, the lines of the Bolzano armchair are clean and minimalistic for a contemporary and streamlined look that will never go out of style.</p>
...
<div class="HelenaPicks">
    ...
    <div class="SweetChair">
        <a href="https://www.google.com/"><img src="../Images/SweetChair.jpg" alt="SweetChair" title="SweetChair"></a>  
    ...
    <div class="SweetOttoman">
        <a href="ArtChair.php"><img src="../Images/Ottoman.jpg" alt="Sweet Art ottoman" title="Sweet Art ottoman"></a>  
