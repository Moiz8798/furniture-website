...
@media (max-width: 768px) {
    ...
    .SweetChair, .SweetOttoman, .Bergamo, .Bolzano, .Bellagio {
        width: 90%;
    }
...
<div class="AllContainer" style="display: flex; margin-top: 2%; gap: 20%;">
    ...
    <div class="Container1" style="width: 30%; margin-left: 5%; font-size: 24px">
        <strong><p>With its cubic Moiz design expression, our signature Carmo sofa has been updated for a more refined look and enhanced comfort. Its free-standing design allows you to easily reorganise its modules at any time, for any occasion. Whether you are hosting guests or seeking a quiet moment, Carmo effortlessly adapts to your needs.</p></strong>

    </div>

    <div class="Container2">
        <button style="font-size: 20px; width: 150%; padding: 15px;background-color: black; color: white;" onclick="window.location.href='CarmoSofaProductDetails.php'">Product Details</button>
        <button style="font-size: 20px; width: 150%; padding: 15px; margin-top: 10%;background-color: black; color: white;" onclick="window.location.href='CarmoSofaMeasurements.php'">Measurements</button>
...
<div clas="ArtImage" style="margin-top: 3%;">
    <iframe src="../Images/CarmoSofaVideo.mp4" 
    title="CarmoSofaVideo" frameborder="0" allowfullscreen>
</iframe>
</div>
...
<div class="Details" style="display: flex; gap:20%">
    <div class="Box1" style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-left: 2%;">
        <h2 style="font-weight: bold; ">Soft all around</h2>
        <p>The inside frame of the arm and backrest is cut out and covered with soft foam. This makes both the armrest and the backrest very soft and optimizes your comfort.</p>
    </div>
    ...
    <div class="Box2"  style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-right: 1%;"> 
        <h2 style="font-weight: bold; ">Low comfortable back</h2>
        <p>The low comfortable back has the same height as the armrest giving a fantastic seating comfort, especially in the corner.</p>
