...
<html>
    <head>
        ...
        <title>BolzoneChairMeasurementsDetails</title>
    ...
    <body>
        ...
        <h1 style="margin-left: 5%; color: white;">Bolzone Chair Measurements Details</h1>
        <h2 style="color: white;text-align: center;">Dimensions and weights</h2>
        <div class="ArtDetails"> 
            <div class="Info">
                <?php
                include('../PhpFiles/db_connection.php'); 
                include('../PhpFiles/BolzoneMeasurements.php'); 
            
                getBolzoneMeasurements($conn);
            ?>
            </div>
        </div>
    </body>
