...
<html>
    <head>
        ...
        <title>DiningChairProductDetails</title>
    ...
    <body>
        ...
        <h1 style="margin-left: 5%; color: white;">Dining Chair Product Details</h1>
        <div class="ArtDetails"> 
            <div class="Info">
                <?php
                include('../PhpFiles/db_connection.php'); 
                include('../PhpFiles/DiningChairProduct.php'); 
                getDiningChairProductDetails($conn)
                ?>
            </div>
        </div>
    </body>
