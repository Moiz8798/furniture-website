...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $show_form) {
    if (empty($_POST['username']) || empty($_POST['email']) || empty($_POST['address']) || empty($_POST['payment'])) {
        ...
        try {
            ...
            $receipt_text .= "<a href='../HtmlFiles/HomePage.php' style='text-decoration: none; color: #fff; background-color: #4CAF50; padding: 10px 20px; border-radius: 5px; margin-right: 10px;' onclick='console.log(\"Navigating to HomePage.php\");'>Continue Shopping</a>";
...
<body>
    <div class="navbar">
        ...
        <div class="logo"><a href="../HtmlFiles/HomePage.php">Ajmal Furniture</a></div>
        <div class="nav-right">
