...
function getProducts() {
    ...
    try {
        ...
        $stmt = $pdo->query("SELECT * FROM products where Category = 'outdoor'");  
  ...
  <div class="logo">Ajmal Furniture</div>
    ...
    <main>
        ...
        <h1>Outdoor furniture</h1>
         <p class="subtitle">Discover outdoor design collections</p>
        <br>
        <br>
        <br>
    ...
    <?php if ($products): ?>
        <?php foreach ($products as $product): ?>
            <div class="product">
                <a href="addtocart.php?type=outdoor&product_id=<?php echo htmlspecialchars($product['id']); ?>" class="product-image-link">
    ...
    <footer>
        <div class="footer-content">
            <div class="intro">
                <h2>Outdoor and garden designer furniture</h2>
                <p>Design furniture for your outdoor area. Garden and patio furniture to make your outdoor space the place to be for dining, relaxation and good times with loved ones...</p>
            </div>
        </div>
        <footer class="footer">
        <div class="footer-content">
