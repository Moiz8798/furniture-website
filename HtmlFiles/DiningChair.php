    ...
    <head>
        ...
        <style>
            ...
            @media (max-width: 992px) {
                ...
                .SweetChair, .SweetOttoman, .Bergamo, .Bolzano, .Bellagio, .CoffeeTable {
                    width: 100%;
                    font-size: 18px;
                }
                .Box1, .Box2 {
...
$productName = 'Seoul Dining Chair';
...
<div class="AllContainer" style="display: flex; margin-top: 2%; gap: 20%;">
    ...
    <div class="Container1" style="width: 30%; margin-left: 5%; font-size: 24px">
        <strong><p>Grounded in principles of simplicity and craftsmanship, Seoul’s clean lines and understated elegance pay homage to the timeless design traditions that have defined Moiz design for generations – yet with a contemporary touch. it invites you to sit back and dine in comfort, with its A-frame-style shape, short armrests and angled legs.</p></strong>

    </div>

    <div class="Container2">
        <button style="font-size: 20px; width: 150%; padding: 15px;background-color: black; color: white;" onclick="window.location.href='DiningChairProductDetails.php'">Product Details</button>
        <button style="font-size: 20px; width: 150%; padding: 15px; margin-top: 10%;background-color: black; color: white;" onclick="window.location.href='DiningChairMeasurements.php'">Measurements</button>
...
<div clas="ArtImage" style="margin-top: 3%;">
    ...
    <iframe src="../Images/DiningChairVideo.mp4" 
    title="DiningChairVideo" frameborder="0" allowfullscreen>
</iframe>
...
<div class="Details" style="display: flex; gap:20%">
    <div class="Box1" style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-left: 2%;">
        <h2 style="font-weight: bold; ">Natural beauty</h2>
        <p>A celebration of the natural diversity of wood, the Seoul dining chair features varied colour and grain patterns. These unique differences are not flaws but add character to the piece.</p>
    </div>
    ...
    <div class="Box2"  style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-right: 1%;"> 
        <h2 style="font-weight: bold; ">What does Seoul bring to a room?</h2>
        <p>“Don’t underestimate the impact of a wooden chair,” says designer, Henrik Pedersen. “It’s the craftsmanship, the inviting curves and just the wonderfully tactile qualities wood brings. It invites you in. You want to feel it.”</p>
