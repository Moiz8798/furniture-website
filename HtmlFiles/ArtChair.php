...
<html>
 ...
 <style>
        ...
        @media (max-width: 768px) {
            ...
            .SweetOttoman, .Bergamo, .Bolzano, .Bellagio, .CoffeeTable, .DiningChair, .CornerSofa {
                width: 100%;
                margin-left: 0;
                margin-right: 0;
                text-align: center;
...
$productName = 'Sweet Art chair with swivel base';
...
<div class="AllContainer" style="display: flex; margin-top: 2%; gap: 20%;">
    ...
    <div class="Container1" style="width: 30%; margin-left: 5%; font-size: 24px">
        <strong><p>Combining bold design with playful indulgence, the limited edition Sweet Art armchair makes a striking statement. Inspired by the soft curves and creamy textures of Moiz pastries, its sculpted shape and scalloped detailing offer a perfect balance of elegance and comfort. Finished with a swivel base, this unique piece evokes Scandinavian charm and timeless design.</p></strong>

    </div>

    <div class="Container2">
        <button style="font-size: 20px; width: 150%; padding: 15px;background-color: black; color: white;" onclick="window.location.href='ArtChairProductDetails.php'">Product Details</button>
        <button style="font-size: 20px; width: 150%; padding: 15px; margin-top: 10%;background-color: black; color: white;" onclick="window.location.href='ArtChairMeasurements.php'">Measurements</button>
...
<div clas="ArtImage" style="margin-top: 3%;">
        ...
        <img src="../Images/ArtImage.jpg" alt="ArtImage" title="ArtImage" style="width: 97%; height: 10%; margin-left: 2%;margin-right: 2%; border: 2px solid transparent; border-radius: 10px; box-shadow:0px 0px 10px gray;">
</div>
...
<div class="Details" style="display: flex; gap:20%">
    <div class="Box1" style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-left: 2%;">
        ...
        <p>Exclusive introductory prices until September 2025</p>
    </div>
    ...
    <div class="Box2"  style="border: 2px solid transparent; padding: 3px; text-align: center; width: 40%; background-color: rgb(250, 248,238); color: rgb(95, 76, 39); margin-right: 1%;"> 
        <h2 style="font-weight: bold; ">Sweet and speedy</h2>
        <p>Special Edition Blossom bouclé</p>
