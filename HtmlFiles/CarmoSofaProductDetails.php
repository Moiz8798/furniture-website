...
<html>
    <head>
        ...
        <title>Carmo Sofa Product Details</title>
...
@media (max-width: 576px) {
    ...
    <body>
        ...
        <h1 style="margin-left: 5%; color: white;">Carmo Sofa Product Details</h1>
        <div class="ArtDetails"> 
            <div class="Info">
                <?php
                include('../PhpFiles/db_connection.php'); 
                include('../PhpFiles/CarmoProducts.php'); 
            
                getCarmoProductDetails($conn) 
            ?>
            </div>
        </div>
    </body>
